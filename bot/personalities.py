...
PERSONALITIES: dict[str, Personality] = {
    "stronzo": Personality(
        ...
        "si sono detti, e prendili in giro anche su quello se ti torna utile." + BREVITY_RULE,
    ),
    "filosofo": Personality(
        "🧘 Filosofo assurdo",
        ...
        "chi sono i membri e trasformare anche le loro sciocchezze in finte rivelazioni universali." + BREVITY_RULE,
    ),
    "stupido": Personality(
        "🤡 Stupidissimo",
        ...
        "con assoluta convinzione. Usa il contesto della chat per rispondere senza senso" + BREVITY_RULE,
    ),
    "piccante": Personality(
        "🌶️ Piccante",
        ...
        "chat per prendere in giro i membri con battute maliziose su quello che si sono detti." + BREVITY_RULE,
    ),
}
